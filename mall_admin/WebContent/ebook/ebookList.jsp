										...
										<div class="single-place mb-30">
											...
											<div class="place-cap">
												<div class="place-cap-top">
													<span><i class="fas fa-star"></i><span><%=e.getCategoryName()%></span> </span>
													<!-- 타이틀 -->
													<h3>
														<a
												...
												<div class="place-cap-bottom">
													<ul>
														<li><i class="far fa-clock"></i><%=e.getEbookDate().substring(0,10)%></li>
													</ul>
												</div>
											</div>
										</div>
				...
				<div class="col-lg-4">
					<div class="blog_right_sidebar">
						<aside class="single_sidebar_widget search_widget">
							...
							<a href="<%=request.getContextPath()%>/ebook/insertEbookForm.jsp"><button type="button"
