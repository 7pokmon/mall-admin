...
<!-- 인클루드 -->
    ...
    <footer>
        <!-- Footer Start-->
        <div class="footer-area footer-padding footer-bg" data-background="<%=request.getContextPath()%>/assets/img/service/footer_bg.jpg">
            <div class="container">
                       ...
                       <div class="single-footer-caption mb-50">
                         <div class="single-footer-caption mb-30">
                             ...
                             <div class="footer-logo">
                                 <a href="index.html"><img src="<%=request.getContextPath()%>/assets/img/logo/logo2_footer.png" alt=""></a>
                             </div>
